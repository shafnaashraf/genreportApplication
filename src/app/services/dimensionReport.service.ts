...
export class DimensionReportService{
    private apiUrl = environment.apiUrl + '/api/dimension';
    ...
    searchDimensionReportItems(jobNumber: string, subJobNumber: string, drawingNo: string): Observable<DimensionItemVO[]> {
        ...
        return this.http.get<any[]>(`${this.apiUrl}/getDimensionReportDetails`, { params })
